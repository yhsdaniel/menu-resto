...
//   },
//   {
//     id: 5, name: 'Salad', description: 'Sayuran segar dengan bumbu kacang khas Jakarta',
...
export const tables: TableInfo[] = Array.from({ length: 20 }, (_, index) => ({
  id: `table-${index + 1}`,
  number: index + 1,
  capacity: index < 8 ? 2 : index < 14 ? 4 : 6,
  status: 'available',
}));
